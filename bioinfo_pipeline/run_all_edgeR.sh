#!/bin/bash
# ===================================================================
# RUN ALL edgeR ANALYSES
# ===================================================================
# Loops over every *_counts_clean.txt in DEG/ and runs edgeR.
# Housekeeping genes (housekeeping_genes.xlsx) are located
# automatically from several candidate paths and copied to /data/
# so that run_edgeR_analysis.R (PROJECT_DIR="/data") always finds
...
# NOTE: run_edgeR_analysis.R hardcodes PROJECT_DIR="/data", so the
#       file must always end up at /data/housekeeping_genes.xlsx.
HKG_CANDIDATES=(
...
# -------------------------------------------------------------------
# RUN edgeR FOR EACH COUNT MATRIX
# -------------------------------------------------------------------
echo ""
echo "=========================================="
echo "edgeR ANALYSIS"
...
echo ""
echo "=========================================="
echo "✅ All edgeR analyses complete!"
